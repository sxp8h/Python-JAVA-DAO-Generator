...
def generateHeader():
	...
	classEntry = "public class {} ".format(new_file)
	classEntry += '{\n'
	...
	file = sxp8h+package+imports+classEntry+connection
...
def generateCRUD():
	...
	for at in attributes:
		at = at.split(":")
		line += '\n\t\t{} {} = (bean.get{}() == null || bean.get{}().equals("")) ? "<EMPTY_{}>" : bean.get{}();'.format(at[1], at[0], at[0].title(), at[0].title() ,at[0].upper(),at[0].title())
	...
	line += '\t\t\tPreparedStatement readSt = con.preparedStatement(sql);\n'
